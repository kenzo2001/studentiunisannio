...
def initialize_database():
    with app.app_context():
        ...
        if not Department.query.first(): # Controlla se la tabella Departments è vuota
...
# Il file verrà eseguito direttamente come script, non come un'app Flask in ascolto.
