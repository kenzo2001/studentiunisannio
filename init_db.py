...
def initialize_database():
    ...
    with app.app_context():
        ...
        # 3. FORZIAMO IL POPOLAMENTO DEGLI ESAMI (versione corretta)
        print("INIT_DB: ESEGUENDO POPOLAMENTO FORZATO DEGLI ESAMI...")
        try:
            # CORREZIONE: Cancelliamo prima gli Appunti (Note) per evitare errori
            ...
            db.session.commit() # Salviamo le cancellazioni
